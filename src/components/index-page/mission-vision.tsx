...
export default function MissionVision() {
  return (
    <section
      id="mission-vision"
      className="relative bg-gradient-to-br from-emerald-50 via-amber-50 to-yellow-50 py-16 md:py-28 space-y-10"
    >
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          {/* Image with Sticky Effect */}
          <motion.div
            className="sticky h-full lg:top-20 self-start"
        ...
        >
          ...
          <motion.div
            className="pl-6 grid grid-cols-1 md:grid-cols-2 gap-6 w-full"
            initial="hidden"
            whileInView="visible"
